...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    fileInput.addEventListener("change", async function () {
        ...
        // fileInput.files - псевдомассив выбранных файлов
        // У нас только один файл, поэтому fileInput.files[0]
    ...
    deletePictureButton.addEventListener("click", async function () {
        try {
            ...
            if (response.startsWith("success")) {
                ...
                const updateProfilePicturePath = await getProfilePicture();
                if (updateProfilePicturePath !== "null") {
                    profilePicture.src = updateProfilePicturePath;
                } else {
                    profilePicture.src = "avatars/placeholder.png";
                }
            }
